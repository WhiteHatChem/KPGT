settings={
    ...
    "clintox":{
        "output_names":["FDA_APPROVED","CT_TOX"],
        "output_type":"classification",
        "metric":"rocauc",
    },
    "esol":{
        "output_names":["logSolubility"],
        "output_type":"regression",
        "metric":"rmse",
        "units":"log(mol/L)"
    },
    "freesolv":{
        "output_names":["freesolv"],
        "output_type":"regression",
        "metric":"rmse",
        "units":"kcal/mol"
    },
    ...
    "sider":{
        "output_type":"classification",
        "metric":"rocauc",
        "output_names":["Hepatobiliary disorders",
    ...
    "toxcast":{
        "output_names":["ACEA_T47D_80hr_Negative",
